...
const fraseCélebre = document.querySelector("#frase");
...
function buscarPalabra() {
    ...
    const frase = frase.textContent;

    if (frase.includes(palabraBuscada)) {
        // Si la palabra buscada se encuentra en la frase, la destacamos en verde
        fraseCélebre.innerHTML = frase.replace(new RegExp(palabraBuscada, "gi"), match => `<span style="color: green">${match}</span>`);
    }
}
